<?php
class Makina_Accordionnavigation_Block_Accordionnavigation extends Mage_Catalog_Block_Navigation
{

	public function _construct() {
		$this->setTemplate('Makina/accordionnavigation/accordionnavigation.phtml');
